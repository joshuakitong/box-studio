      ...
      <div className="relative w-full max-w-3xl mx-auto rounded-4xl overflow-hidden border border-white">
        <div className="bg-black/80 backdrop-blur-sm text-white px-4 py-6">
          <p className="text-sm sm:text-md md:text-lg lg:text-xl text-center">
            ...
            At Box Studio, we turn artists’ creative ideas into fully produced tracks, blending technical expertise with a genuine passion for music. We regularly collaborate with local and independent artists, supporting projects from concept through release.
          </p>
        </div>
      </div>
    </div>
